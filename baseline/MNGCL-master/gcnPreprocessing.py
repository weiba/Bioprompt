...
def cross_validation_sets(y, mask):
    ...
    for i in range(10):
        ...
        kf = sklearn.model_selection.StratifiedKFold(n_splits=5, shuffle=True, random_state=42)
        ...
        for train, test in splits:
            ...
            k_folds.append((y_train, y_test, train_mask, test_mask))

        k_sets[i] = k_folds
    # torch.save(k_sets, 'k_sets.pkl')
    return k_sets
